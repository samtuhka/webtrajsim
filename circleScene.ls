...
export circleScene = seqr.bind (env, rx, ry, length, control = true, ellipse = true, rocksOnPath = false, straight = false, texture) ->*
	...
	if ellipse == true
		...
		yield P.resolve addCircleGround scene, rx, ry, length, rocksOnPath, straight, texture
